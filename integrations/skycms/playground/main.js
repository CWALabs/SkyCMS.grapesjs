...
async function start() {
    ...
    const editor = grapesjs.init( {
        ...
        plugins: [
            ...sharedPlugins,
            ...layoutPlugins.plugins
        ],
        pluginsOpts: {
            ...sharedPluginOptions,
            ...layoutPlugins.options
        },
        components: '<section style="padding:24px"><h1>SkyCMS GrapesJS Playground</h1><p>Mode: ' + layoutPlugins.mode + '. Use ?layout=bootstrap5, ?layout=bootstrap4, ?layout=tailwind, or omit for default.</p></section>'
    } );
