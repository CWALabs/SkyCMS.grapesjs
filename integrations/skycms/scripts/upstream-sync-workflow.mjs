...
function printHelp() {
  ...
  console.log(
    '  prepare-sync-branch [--source-remote <name>] [--source-branch <name>] [--mirror-branch <name>] [--automation-branch <name>] [--push]',
  );
  console.log('  merge-into-skycms [--automation-branch <name>] [--custom-branch <name>] [--push]');
  console.log(
    '  run-all [--source-remote <name>] [--source-branch <name>] [--mirror-branch <name>] [--automation-branch <name>] [--custom-branch <name>] [--push] [--merge]',
  );
  console.log('');
