    ...
    editor.setCustomRte( {
        ...
        async enable( el, rte ) {
            ...
            if ( typeof createCkEditor !== 'function' ) {
                ...
                console.warn( 'CKEditor host factory is not available. Rich text editing stays disabled instead of falling back to GrapesJS native RTE.', diagnostics );
            ...
            if ( !el[ ckEditorInitPromiseProp ] ) {
                const initPromise = Promise
                    .resolve( resolveEditorInstance( el, createCkEditor ) )
                    .catch( error => {
